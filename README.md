...
Для канала `@tochka_vx` (`-1002575306027`) публикация через CLI и `POST /post`
разрешена только с 09:00 до 21:00 по Москве и не чаще одного успешного поста
в календарный час. При нарушении CLI завершается с ошибкой, а HTTP API отвечает
429 с пояснением на русском. Остальные каналы не ограничиваются.
